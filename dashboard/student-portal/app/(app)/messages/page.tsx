   ...
   <div className="flex-1 overflow-y-auto">
    {filtered.map((f) => (
     <button
      ...
      className={`w-full flex items-start gap-3 px-4 py-3.5 hover:bg-gray-50 text-left border-b border-gray-50 ${
  ...
  <div className="flex flex-col h-full bg-white">
        ...
        return (
         <div key={msg.id} className={`flex gap-2 ${isMe ? "justify-end" : "justify-start"}`}>
          ...
          <div className={`max-w-[75%] group`}>
           <div className={`px-3 py-1.5 rounded-lg text-sm leading-relaxed ${
            isMe
   ...
   <div className="px-5 py-4 border-t border-gray-100">
    <div className="flex items-end gap-3">
     <div className="flex-1 bg-gray-100 rounded-lg px-4 py-3 flex items-end gap-2">
      <textarea
       value={input}
