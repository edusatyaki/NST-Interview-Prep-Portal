        ...
        {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day) => {
          ...
          return (
            <button
              ...
              disabled={!avail}
              onClick={() => onSelect(ds)}
              className={`aspect-square w-full rounded-lg text-xs font-semibold transition-all flex items-center justify-center ${
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {showJoin && session.meetLink && (
          <a
            ...
            className="shrink-0 flex items-center gap-2 bg-green-600 text-white text-sm font-semibold px-4 py-2.5 rounded-xl hover:bg-green-700 transition-colors"
          >
      ...
      {session.status === "proposed" && session.proposedDate && (
        <div className="mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4">
          ...
          <div className="flex gap-2 mt-3">
            ...
            <button className="flex items-center gap-1.5 border border-gray-300 text-gray-600 text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors">
          ...
          {selectedDate && (
            <div className="bg-white border border-gray-200 rounded-xl p-4">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white text-sm font-semibold py-2.5 rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
              >
